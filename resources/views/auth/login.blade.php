...
@section('title', 'Masuk - Website Resmi Desa Kilwaru')

@section('content')
    <div class="fade-in">
        <!-- Toggle Login/Register -->
        <div class="auth-toggle">
            <button type="button" class="auth-toggle-btn active" id="loginTab">
                <i class="bi bi-box-arrow-in-right me-2"></i>Masuk
            </button>
            <button type="button" class="auth-toggle-btn" id="registerTab">

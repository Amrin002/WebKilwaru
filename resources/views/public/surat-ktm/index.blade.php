...
@section('title', 'Surat Keterangan Tidak Mampu - ' . config('app.village_name', 'Desa Kilwaru'))
@section('description', 'Layanan pengajuan Surat Keterangan Tidak Mampu online untuk warga ' .
...
@section('content')
    <!-- Hero Section -->
    <section class="sktm-hero" id="sktmHero">
        <div class="container">
            <div class="text-center">
                <h1 class="display-4 fw-bold mb-4 hero-animation">Surat Keterangan Tidak Mampu</h1>
                <p class="lead hero-animation">Layanan pengajuan SKTM online untuk kemudahan warga
                ...
                <div class="col-lg-5 col-md-6 mb-4">
                    <div class="service-card fade-in">
                        ...
                        <p class="text-muted mb-4">
                            Ajukan permohonan Surat Keterangan Tidak Mampu secara online dengan mudah dan cepat.
                            Pastikan data yang diisi sudah benar dan lengkap.
                        </p>
                        <a href="{{ route('public.surat-ktm.form') }}" class="btn btn-service text-white">
    ...
    <section class="stats-section">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title fade-in">Statistik Layanan SKTM</h2>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="info-card fade-in">
                        ...
                        <ul class="requirements-list text-start">
                            ...
                            <li>Foto rumah tempat tinggal</li>
                            <li>Keterangan penghasilan (jika ada)</li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- Track Modal -->
    <!-- Ganti bagian Track Modal dengan ini: -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form yang akan redirect langsung ke route track -->
                    <form id="trackingForm" method="GET" action="{{ route('public.surat-ktm.index') }}">
                        <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (trackForm) {
                trackForm.addEventListener('submit', function(e) {
                    ...
                    // Modify form action untuk redirect ke route yang benar
                    const trackUrl = "{{ route('public.surat-ktm.track', ':token') }}".replace(':token',
                        token);
            ...
            console.log('SKTM public page scripts loaded successfully! 📄');
        });

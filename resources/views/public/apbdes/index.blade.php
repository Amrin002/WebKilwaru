...
@section('title', 'Transparansi APBDes - ' . config('app.village_name', 'Desa Kilwaru'))
@section('description',
    'Informasi Anggaran Pendapatan dan Belanja Desa (APBDes) ' .
    config(
    'app.village_name',
    'Desa
    Kilwaru',
    ...
    @push('styles')
        <style>
            ...
            /* CSS untuk memindahkan sidebar ke atas di mobile */
                        ...
                        <form action="{{ route('apbdes.show', 'tahun') }}" method="GET" id="yearForm">
                            <select class="form-select" name="tahun" onchange="submitYearForm(this.value)">
                                ...
                                @foreach ($availableYears as $tahun)
                                    <option value="{{ $tahun }}"
                                        {{ optional($currentApbdes)->tahun == $tahun ? 'selected' : '' }}>
                                        Tahun {{ $tahun }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="col-lg-8 order-lg-1">
                    @if ($currentApbdes)
                        <div class="apbdes-card">
                            <div class="apbdes-card-header">
                                <h2 class="apbdes-card-title">{{ $currentApbdes->tahun }}</h2>
                                <h3 class="fw-bold text-success">{{ $currentApbdes->total_anggaran_formatted }}</h3>
                            </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="meta-item">
                                            <div class="meta-content">
                                                ...
                                                <div class="meta-value">{{ $currentApbdes->pemerintahan_desa_formatted }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="meta-item">
                                            <div class="meta-content">
                                                ...
                                                <div class="meta-value">{{ $currentApbdes->pembangunan_desa_formatted }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="meta-item">
                                            <div class="meta-content">
                                                ...
                                                <div class="meta-value">{{ $currentApbdes->kemasyarakatan_formatted }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="meta-item">
                                            <div class="meta-content">
                                                ...
                                                <div class="meta-value">{{ $currentApbdes->pemberdayaan_formatted }}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="meta-item">
                                            <div class="meta-content">
                                                ...
                                                <div class="meta-value">{{ $currentApbdes->bencana_darurat_formatted }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {{-- Baliho Section --}}
                            @if ($currentApbdes->baliho_image)
                                <div class="mb-4">
                                    <h4 class="fw-bold mb-3">Transparansi Visual</h4>
                                    <img src="{{ Storage::url($currentApbdes->baliho_image) }}"
                                        alt="Baliho APBDes Tahun {{ $currentApbdes->tahun }}" class="image-preview">
                                </div>
                            @endif

                            {{-- Dokumen Section --}}
                            @if ($currentApbdes->pdf_dokumen)
                                <div class="mb-4">
                                    <h4 class="fw-bold mb-3">Dokumen APBDes</h4>
                                    <a href="{{ route('apbdes.download-pdf', $currentApbdes) }}"
                                        class="text-decoration-none">
                                        <div class="document-link-card">
                                            <div class="icon-wrapper" style="background: #17a2b8;">
                                                <i class="bi bi-file-earmark-pdf-fill"></i>
                                            </div>
                                            <p class="mb-0">Unduh Dokumen APBDes Tahun {{ $currentApbdes->tahun }}</p>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <h4>Belum Ada Data APBDes</h4>
                            <p class="text-muted">Informasi APBDes sedang disiapkan. Silakan cek kembali nanti.</p>
                        </div>
                    @endif
                </div>
            </div>

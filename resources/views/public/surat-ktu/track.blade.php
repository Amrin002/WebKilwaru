...
@section('title', 'Tracking Surat Keterangan Usaha - ' . config('app.village_name', 'Desa Kilwaru'))
@section('description', 'Lacak status pengajuan Surat Keterangan Usaha online untuk warga ' . config('app.village_name',
    'Desa Kilwaru'))
                ...
                <div class="col-lg-8">
                    <div class="hero-content text-center hero-animation">
                        <h1 class="display-5 fw-bold text-white mb-3">
                            ...
                            Tracking Surat Keterangan Usaha
                        </h1>
                        <p class="lead text-white mb-4">
                            Lacak status pengajuan surat keterangan usaha Anda
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <h4 class="mb-1 text-primary-green fw-bold">Surat Keterangan Usaha</h4>
                            ...
                            <div class="col-md-4 text-md-end">
                                <div class="status-badge status-{{ $surat->status }}">
                                    <i
                                        class="fas fa-{{ $surat->status === 'diproses' ? 'clock' : ($surat->status === 'disetujui' ? 'check-circle' : 'times-circle') }}"></i>
                ...
                <div class="card border-0 shadow-lg mb-4 fade-in">
                    ...
                    <div class="card-body p-4">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="detail-item">
                                    <label class="detail-label">Nama Usaha</label>
                                    <div class="detail-value">{{ $surat->nama_usaha }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="detail-item">
                                    <label class="detail-label">Jenis Usaha</label>
                                    <div class="detail-value">{{ $surat->jenis_usaha }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="detail-item">
                                    <label class="detail-label">Alamat Usaha</label>
                                    <div class="detail-value">{{ $surat->alamat_usaha }}</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="detail-item">
                                    <label class="detail-label">Pemilik Usaha</label>
                        ...
                        <div class="row g-3 justify-content-center align-items-center">
                            @if ($surat->status === 'disetujui')
                                <div
                                    ...
                                    <a href="{{ route('public.surat-ktu.export', [$surat->id, $surat->public_token]) }}"
                            ...
                            <div class="col-md-5 col-12 d-flex justify-content-md-start justify-content-center">
                                <a href="{{ route('public.surat-ktu.index') }}"

...
@section('title', 'Surat Keterangan Tempat Usaha - ' . config('app.village_name', 'Desa Kilwaru'))
...
@section('content')
    <section class="sktu-hero" id="sktuHero">
        <div class="container">
            <div class="text-center">
                <h1 class="display-4 fw-bold mb-4 hero-animation">Surat Keterangan Usaha</h1>
                <p class="lead hero-animation">Layanan pengajuan SKTU online untuk kemudahan warga
                ...
                <div class="col-lg-5 col-md-6 mb-4">
                    <div class="service-card fade-in">
                        ...
                        <p class="text-muted mb-4">
                            Ajukan permohonan Surat Keterangan Usaha secara online dengan mudah dan cepat.
                            Pastikan data yang diisi sudah benar dan lengkap.
                        </p>
                        <a href="{{ route('public.surat-ktu.form') }}" class="btn btn-service text-white">
    ...
    <section class="stats-section">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title fade-in">Statistik Layanan SKTU</h2>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="info-card fade-in">
                        ...
                        <ul class="requirements-list text-start">
                            ...
                            <li>Keterangan jenis usaha dan lokasi</li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="trackingForm" method="GET" action="{{ route('public.surat-ktu.index') }}">
                        <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (trackForm) {
                trackForm.addEventListener('submit', function(e) {
                    ...
                    const trackUrl = "{{ route('public.surat-ktu.track', ':token') }}".replace(':token',
                        token);
            ...
            console.log('SKTU public page scripts loaded successfully! 📄');
        });

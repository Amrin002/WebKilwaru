...
@push('style')
    <style>
        /* Form Styles - Same as KTM edit but adapted for Surat KTU */
        .form-container {
...
@section('content')
    <div class="dashboard-content">
        <div class="page-header">
            ...
            <h1 class="page-title">Edit Surat Keterangan Usaha</h1>
            <p class="page-subtitle">Perbarui data surat keterangan usaha</p>
        </div>
        ...
        <div class="info-card">
            ...
            <p>
                Anda sedang mengedit data surat KTU. Sebagai admin, Anda dapat mengubah semua data termasuk status surat.
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <h2 class="form-title">Form Edit Surat KTU</h2>
            ...
            <form action="{{ route('admin.surat-ktu.update', $surat->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="input-group-personal">
                        <div class="mb-3">
                            <label for="nama" class="form-label">
                                Nama Lengkap <span class="required">*</span>
                            </label>
                            <input type="text" class="form-control change-indicator @error('nama') is-invalid @enderror"
                                id="nama" name="nama" value="{{ old('nama', $surat->nama) }}"
                                data-original="{{ $surat->nama }}" placeholder="Nama lengkap pemohon" maxlength="100"
                                required>
                            @error('nama')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            <label for="nomor_telepon" class="form-label">
                                Nomor Telepon <span class="required nomor_telepon_required">*</span>
                            </label>
                            <input type="text"
                            ...
                            <div class="form-text">
                                <i class="bi bi-info-circle me-1"></i>
                                <span class="nomor_telepon_note">Wajib diisi untuk guest, opsional untuk user
                                    terdaftar</span>
                            </div>
                            @error('nomor_telepon')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="input-group-birth">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                data-original="{{ $surat->tempat_lahir }}" placeholder="Kota/Kabupaten" maxlength="100"
                                required>
                            @error('tempat_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="input-group-other">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                data-original="{{ $surat->pekerjaan }}" placeholder="Contoh: Wiraswasta" maxlength="50"
                                required>
                            @error('pekerjaan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select change-indicator @error('agama') is-invalid @enderror"
                                id="agama" name="agama" data-original="{{ $surat->agama }}" required>
                                <option value="">-- Pilih Agama --</option>
                                <option value="Islam" {{ old('agama', $surat->agama) == 'Islam' ? 'selected' : '' }}>
                                    Islam</option>
                                <option value="Kristen" {{ old('agama', $surat->agama) == 'Kristen' ? 'selected' : '' }}>
                                    Kristen</option>
                                <option value="Katolik" {{ old('agama', $surat->agama) == 'Katolik' ? 'selected' : '' }}>
                                    Katolik</option>
                                <option value="Hindu" {{ old('agama', $surat->agama) == 'Hindu' ? 'selected' : '' }}>
                                    Hindu</option>
                                <option value="Buddha" {{ old('agama', $surat->agama) == 'Buddha' ? 'selected' : '' }}>
                                    Buddha</option>
                                <option value="Konghucu"
                                    {{ old('agama', $surat->agama) == 'Konghucu' ? 'selected' : '' }}>Konghucu</option>
                            </select>
                            @error('agama')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control change-indicator @error('kewarganegaraan') is-invalid @enderror"
                            id="kewarganegaraan" name="kewarganegaraan"
                            value="{{ old('kewarganegaraan', $surat->kewarganegaraan) }}"
                            data-original="{{ $surat->kewarganegaraan }}" placeholder="Contoh: Indonesia" maxlength="50"
                            required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control change-indicator @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                            data-original="{{ $surat->alamat }}" rows="3" placeholder="Alamat lengkap sesuai KTP" maxlength="255"
                ...
                <div class="form-section">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control change-indicator @error('nama_usaha') is-invalid @enderror"
                            id="nama_usaha" name="nama_usaha" value="{{ old('nama_usaha', $surat->nama_usaha) }}"
                            data-original="{{ $surat->nama_usaha }}" placeholder="Contoh: Toko Kopi Jaya"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                            class="form-control change-indicator @error('jenis_usaha') is-invalid @enderror"
                            id="jenis_usaha" name="jenis_usaha" value="{{ old('jenis_usaha', $surat->jenis_usaha) }}"
                            data-original="{{ $surat->jenis_usaha }}" placeholder="Contoh: Makanan dan Minuman"
                            maxlength="100" required>
                        @error('jenis_usaha')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control change-indicator @error('alamat_usaha') is-invalid @enderror" id="alamat_usaha"
                            name="alamat_usaha" data-original="{{ $surat->alamat_usaha }}" rows="3"
                            placeholder="Alamat lengkap lokasi usaha" maxlength="255" required>{{ old('alamat_usaha', $surat->alamat_usaha) }}</textarea>
                        @error('alamat_usaha')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="pemilik_usaha" class="form-label">
                            Pemilik Usaha <span class="required">*</span>
                        </label>
                        <input type="text"
                            class="form-control change-indicator @error('pemilik_usaha') is-invalid @enderror"
                            id="pemilik_usaha" name="pemilik_usaha"
                            value="{{ old('pemilik_usaha', $surat->pemilik_usaha) }}"
                            data-original="{{ $surat->pemilik_usaha }}" placeholder="Nama pemilik usaha" maxlength="100"
                            required>
                        @error('pemilik_usaha')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="form-section">
                    ...
                    <div class="status-management">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="nomor-surat-group" id="nomorSuratGroup" style="display: none;">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.surat-ktu.show', $surat->id) }}" class="btn btn-outline-danger">
                        <i class="bi bi-eye me-2"></i>Lihat Detail
                    </a>
                    @if ($surat->status === 'disetujui' && $surat->nomor_surat)
                        <a href="{{ route('admin.surat-ktu.download', $surat->id) }}" class="btn btn-success"
                            target="_blank">
...
@push('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const nomorTeleponGroup = document.getElementById('nomor_telepon_group');
            ...
            generateNomorBtn.addEventListener('click', function() {
                ...
                fetch('{{ route('admin.surat-ktu.generate-nomor') }}', {
                        method: 'POST',
                        headers: {
            ...
            function toggleNomorTeleponRequirement() {
                ...
                if (userId) {
                    ...
                    nomorTeleponGroup.classList.remove('required-field');
                } else {
                    ...
                    nomorTeleponGroup.classList.add('required-field');
                }
            }
            ...
            namaUsahaInput.addEventListener('input', function(e) {
                e.target.value = e.target.value.toLowerCase().replace(/\b\w/g, l => l.toUpperCase());
            });

            const jenisUsahaInput = document.getElementById('jenis_usaha');
            jenisUsahaInput.addEventListener('input', function(e) {
                e.target.value = e.target.value.toLowerCase().replace(/\b\w/g, l => l.toUpperCase());
            });

            const pemilikUsahaInput = document.getElementById('pemilik_usaha');
            pemilikUsahaInput.addEventListener('input', function(e) {
                e.target.value = e.target.value.toLowerCase().replace(/\b\w/g, l => l.toUpperCase());
            });
                ...
                if (changes.length > 0) {
                    ...
                    changes.forEach(change => {
                        ...
                        if (change.field === 'Agama') {
                            const selectedOption = document.querySelector(
                                `#agama option[value="${change.to}"]`);
                            toText = selectedOption ? selectedOption.textContent : change.to;
                            const originalOption = document.querySelector(
                                `#agama option[value="${change.from}"]`);
                            fromText = originalOption ? originalOption.textContent : change.from;
                        }
            ...
            form.addEventListener('submit', function(e) {
                ...
                const pemilikUsaha = document.getElementById('pemilik_usaha').value.trim();
                ...
                if (!kewarganegaraan) {
                    e.preventDefault();
                    alert('Kewarganegaraan wajib diisi!');
                    return false;
                }
                ...
                if (!pemilikUsaha) {
                    e.preventDefault();
                    alert('Pemilik usaha wajib diisi!');
                    return false;
                }

                if (!status) {
                    e.preventDefault();
                    alert('Status surat wajib dipilih!');
                    return false;
                }

                // Validate nomor telepon for guest
            ...
            function validateField(field) {
                ...
                if (field.id === 'nama' && value && value.length < 2) {
                    isValid = false;
                    message = 'Nama minimal 2 karakter';
                }

                if (field.id === 'nama_usaha' && value && value.length < 2) {
                    isValid = false;
                    message = 'Nama usaha minimal 2 karakter';
                }

                if (field.id === 'jenis_usaha' && value && value.length < 2) {
                    isValid = false;
                    message = 'Jenis usaha minimal 2 karakter';
                }

                if (field.id === 'pemilik_usaha' && value && value.length < 2) {
                    isValid = false;
                    message = 'Nama pemilik usaha minimal 2 karakter';
                }

                if (field.id === 'pekerjaan' && value && value.length < 2) {
                    isValid = false;
                    message = 'Pekerjaan minimal 2 karakter';
                }

                if (field.id === 'nomor_telepon' && value && value.length < 10) {
                    isValid = false;
                    message = 'Nomor telepon minimal 10 digit';
                }

                if (field.id === 'tanggal_lahir' && value) {

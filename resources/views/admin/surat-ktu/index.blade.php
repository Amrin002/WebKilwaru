{{-- Surat KTU Management --}}
@extends('layouts.main')

@push('style')
    <style>
        /* Surat KTU Management Styles - Consistent with Arsip Surat Theme */
        .page-header {
        ...
        <div class="page-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Surat KTU</li>
                </ol>
            </nav>
            <h1 class="page-title">{{ $titleHeader ?? 'Surat Keterangan Usaha' }}</h1>
            <p class="page-subtitle">Kelola pengajuan surat keterangan usaha dari warga dan guest</p>
        </div>
        ...
        <div class="filter-section">
            <div class="filter-header">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.surat-ktu.create') }}" class="btn btn-primary">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            {{-- <li><a class="dropdown-item" href="{{ route('admin.surat-ktu.export', request()->query()) }}">
                            ...
                            <li><a class="dropdown-item" href="{{ route('admin.surat-ktu.api.statistik') }}">
            ...
            <div class="bulk-actions" id="bulkActions">
                <form action="{{ route('admin.surat-ktu.bulk-action') }}" method="POST" id="bulkForm">
                    @csrf
            ...
            <form method="GET" action="{{ route('admin.surat-ktu.index') }}" class="row g-3">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.surat-ktu.index') }}" class="btn btn-outline-primary">
        ...
        <div class="data-table-container">
            <div class="table-header">
                <h4 class="table-title">
                    <i class="bi bi-file-text me-2"></i>Daftar Surat KTU
                </h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('admin.surat-ktu.show', $surat->id) }}"
                                                class="btn btn-sm btn-outline-primary" title="Detail">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.surat-ktu.edit', $surat->id) }}"
                                                class="btn btn-sm btn-warning" title="Edit">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            @if ($surat->status == 'disetujui' && $surat->nomor_surat)
                                                <a href="{{ route('admin.surat-ktu.export', $surat->id) }}"
                                                    class="btn btn-sm btn-success" title="Download" target="_blank">
                                                    <i class="bi bi-download"></i>
                                                </a>
                                            @endif
                                            <form action="{{ route('admin.surat-ktu.destroy', $surat->id) }}"
            ...
            @else
                <div class="empty-state">
                    <i class="bi bi-file-text"></i>
                    <h5>Tidak ada surat KTU</h5>
                    <p class="mb-3">Belum ada pengajuan surat keterangan usaha</p>
                    <a href="{{ route('admin.surat-ktu.create') }}" class="btn btn-primary">
...
@push('script')
    <script>
        // Perbaikan JavaScript untuk Modal Status Update Surat KTU
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (updateStatusForm) {
                updateStatusForm.addEventListener('submit', function(e) {
                    ...
                    // Send AJAX request
                    fetch(`/admin/surat-ktu/${suratId}/update-status`, {
                            method: 'PATCH',
        ...
        setInterval(function() {
            if (document.visibilityState === 'visible') {
                ...
                if (currentUrl.includes('surat-ktu')) {
                    fetch('/admin/surat-ktu/api/statistik')

...
@section('content')
    <div class="dashboard-content">
        <div class="page-header">
            ...
            <h1 class="page-title">Detail Surat Keterangan Usaha</h1>
            <p class="page-subtitle">Informasi lengkap data surat keterangan usaha dalam sistem</p>
        </div>
        ...
        <div class="action-buttons">
            ...
            @if ($surat->status !== 'disetujui')
                <a href="{{ route('admin.surat-ktu.edit', $surat->id) }}" class="btn btn-warning">
            ...
            @if ($surat->status === 'disetujui' && $surat->nomor_surat)
                <a href="{{ route('admin.surat-ktu.export', $surat->id) }}" class="btn btn-success" target="_blank">
            ...
            <form action="{{ route('admin.surat-ktu.destroy', $surat->id) }}" method="POST" style="display: inline-block;"
        ...
        <div class="detail-container">
            <div class="detail-header">
                ...
                <h2 class="detail-title">Surat Keterangan Usaha</h2>
                <p class="detail-subtitle">Data lengkap informasi surat keterangan usaha</p>
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $surat->nama_usaha }}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">
                        ...
                        <div class="detail-value">{{ $surat->jenis_usaha }}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">
                        ...
                        <div class="detail-value">{{ $surat->pemilik_usaha }}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">
                        ...
                        <div class="detail-value">{{ $surat->alamat_usaha }}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="user-info-card">
                        ...
                        <div class="address-full">
                            ...
                            <button class="copy-btn float-end"
                                onclick="copyToClipboard('{{ route('public.surat-ktu.track', $surat->public_token) }}', this)"
    ...
    <div class="status-modal" id="statusModal">
        <div class="modal-content">
            ...
            <form id="statusForm" method="POST" action="{{ route('admin.surat-ktu.update-status', $surat->id) }}">
                @csrf
                @method('PATCH')

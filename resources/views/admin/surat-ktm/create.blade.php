...
@section('content')
    <div class="dashboard-content">
        ...
        <div class="page-header">
            ...
            <h1 class="page-title">Buat Surat Keterangan Tidak Mampu</h1>
            <p class="page-subtitle">Lengkapi form di bawah untuk membuat surat KTM baru dalam sistem</p>
        </div>
        ...
        <div class="info-card">
            ...
            <p>
                Sebagai admin, Anda dapat membuat surat KTM untuk pengguna terdaftar atau sebagai guest (tanpa akun).
                Pastikan data yang dimasukkan sesuai dengan dokumen identitas yang valid.
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <h2 class="form-title">Form Buat Surat KTM</h2>
                <p class="form-subtitle">Masukkan data surat keterangan tidak mampu dengan lengkap dan benar</p>
            </div>

            <form action="{{ route('admin.surat-ktm.store') }}" method="POST" novalidate>
                @csrf

                <!-- Section 1: Jenis Pemohon -->
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (!isUserMode && phoneInput.value) {
                    ...
                    if (!phone.startsWith('08') && !phone.startsWith('62')) {
                        isValid = false;
                        errorMessage = 'Nomor telepon harus dimulai dengan 08 atau 62!';
                    }
                }

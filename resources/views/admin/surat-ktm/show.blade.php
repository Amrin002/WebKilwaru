...
@section('content')
    <div class="dashboard-content">
        ...
        <div class="page-header">
            ...
            <h1 class="page-title">Detail Surat Keterangan Tidak Mampu</h1>
            <p class="page-subtitle">Informasi lengkap data surat keterangan tidak mampu dalam sistem</p>
        </div>
        ...
        <div class="action-buttons">
            ...
            @if ($surat->status !== 'disetujui')
                <a href="{{ route('admin.surat-ktm.edit', $surat->id) }}" class="btn btn-warning">
            ...
            <form action="{{ route('admin.surat-ktm.destroy', $surat->id) }}" method="POST" style="display: inline-block;"
        ...
        <div class="detail-container">
            ...
            <div class="detail-header">
                ...
                <h2 class="detail-title">Surat Keterangan Tidak Mampu</h2>
                <p class="detail-subtitle">Data lengkap informasi surat keterangan tidak mampu</p>
            ...
            <!-- User Info Card (if registered user) -->
            ...
            <div class="address-card">
                <div class="address-card-header">
                    ...
                    <h4 class="address-title">Alamat Lengkap Pemohon</h4>
                </div>
                <div class="address-full">
                    {{ $surat->alamat }}
                    <button class="copy-btn float-end" onclick="copyToClipboard('{{ $surat->alamat }}', this)"
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value large highlight">{{ $surat->nama }}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $surat->tempat_lahir }}</div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">
                        ...
                        <div class="detail-value">{{ \Carbon\Carbon::parse($surat->tanggal_lahir)->format('d F Y') }}
                        </div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-label">
            ...
            <div class="detail-section">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <div class="detail-value large">{{ $surat->id }}</div>
                    </div>
                    @if ($surat->nomor_surat)
                        <div class="detail-item">
                            <div class="detail-label">
                            ...
                            <div class="detail-value large highlight">{{ $surat->nomor_surat }}</div>
                        </div>
                    @endif
                    <div class="detail-item">
                        <div class="detail-label">
                    ...
                    @if ($surat->public_token && !$surat->user_id)
                        <div class="detail-item">
                            <div class="detail-label">
                                <i class="bi bi-key"></i>
                                Token Tracking
                            ...
                            <div class="detail-value">
                                {{ substr($surat->public_token, 0, 8) }}...
                                <button class="copy-btn" onclick="copyToClipboard('{{ $surat->public_token }}', this)"
                                    title="Salin token tracking">
                                    <i class="bi bi-copy"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    @if ($surat->arsip)
                        <div class="detail-item">
                            ...
                            <div class="detail-value">
                                <span class="badge bg-success">Sudah Diarsipkan</span>
                            </div>
                        </div>
                    @endif
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="keterangan-card empty">
                        <div class="text-center text-muted">
                            <i class="bi bi-chat-text-fill fs-2 mb-2"></i>
            ...
            <!-- Section 4: Tracking Link for Guest -->
                ...
                <div class="detail-section">
                    ...
                    <div class="user-info-card">
                        ...
                        <div class="address-full">
                            ...
                            <button class="copy-btn float-end"
                                onclick="copyToClipboard('{{ route('public.surat-ktm.track', $surat->public_token) }}', this)"
    ...
    <div class="status-modal" id="statusModal">
        <div class="modal-content">
            ...
            <form id="statusForm" method="POST" action="{{ route('admin.surat-ktm.update-status', $surat->id) }}">
                @csrf
                @method('PATCH')

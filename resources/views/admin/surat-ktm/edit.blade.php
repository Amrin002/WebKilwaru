...
@push('style')
    <style>
        /* Form Styles - Same as KK edit but adapted for Surat KTM */
        .form-container {
...
@section('content')
    <div class="dashboard-content">
        ...
        <div class="page-header">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.surat-ktm.index') }}">Surat KTM</a></li>
                    <li class="breadcrumb-item active">Edit Surat</li>
                </ol>
            </nav>
            <h1 class="page-title">Edit Surat KTM</h1>
            <p class="page-subtitle">Perbarui data surat keterangan tidak mampu</p>
        </div>
        ...
        <div class="info-card">
            ...
            <p>
                Anda sedang mengedit data surat KTM. Sebagai admin, Anda dapat mengubah semua data termasuk status surat.
        ...
        <div class="form-container">
            <div class="form-header">
                ...
                <h2 class="form-title">Form Edit Surat KTM</h2>
            ...
            <form action="{{ route('admin.surat-ktm.update', $surat->id) }}" method="POST" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    ...
                    <div class="input-group-personal">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control change-indicator @error('nama') is-invalid @enderror"
                                ...
                                data-original="{{ $surat->nama }}" placeholder="Nama lengkap pemohon" maxlength="255"
                                required>
                            @error('nama')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3" id="nomor_telepon_group">
                    ...
                    <div class="input-group-birth">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                data-original="{{ $surat->tempat_lahir }}" placeholder="Kota/Kabupaten" maxlength="255"
                                required>
                            @error('tempat_lahir')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="input-group-status">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select change-indicator @error('status_kawin') is-invalid @enderror"
                                id="status_kawin" name="status_kawin" data-original="{{ $surat->status_kawin }}"
                                required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"
                                ...
                                data-original="{{ $surat->kewarganegaraan }}" placeholder="Indonesia" maxlength="255"
                                required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control change-indicator @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                data-original="{{ $surat->alamat }}" rows="3" placeholder="Alamat lengkap sesuai KTP" required>{{ old('alamat', $surat->alamat) }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <!-- Section 3: Status & Administrasi Surat -->
                <div class="form-section">
                    <h4 class="section-title">
                        <div class="section-icon">
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.surat-ktm.index') }}" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left me-2"></i>Kembali
                    </a>
                    <a href="{{ route('admin.surat-ktm.show', $surat->id) }}" class="btn btn-outline-danger">
                        <i class="bi bi-eye me-2"></i>Lihat Detail
                    </a>
                    @if ($surat->status === 'disetujui' && $surat->nomor_surat)
                        <a href="{{ route('admin.surat-ktm.download', $surat->id) }}" class="btn btn-success"
                            target="_blank">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            generateNomorBtn.addEventListener('click', function() {
                ...
                fetch('{{ route('admin.surat-ktm.generate-nomor') }}', {
                        method: 'POST',
                        headers: {
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (!statusKawin) {
                    e.preventDefault();
                    alert('Status perkawinan wajib dipilih!');
                    return false;
                }
